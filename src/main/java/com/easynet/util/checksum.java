...
public class checksum {
	...
	private static final String CHECKSUM_KEY = common.getConfig("checksum_key");
	private static final int[] crctable = { 0x00000000, 0x77073096, 0xEE0E612C, 0x990951BA, 0x076DC419, 0x706AF48F,
